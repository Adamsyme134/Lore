...
// ✨ IMPORT THE NEW EXECUTION CONTEXT
...
export default function QuestDetailScreen() {
  ...
  return (
    <Screen contentClassName="px-0 pb-36">
      ...
      {/* ✨ WRAP THE ENTIRE QUEST CONTENT IN THE EXECUTION PROVIDER ✨ */}
      {/* This allows any widget inside this screen to read/write shared variables */}
